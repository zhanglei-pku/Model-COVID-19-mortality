...
close all;
clc;
tableSD = readtable('State-Data-wave4.csv');
...
positon_3p3 = [939,154,680,612];%3×3

gcf1 = figure('position',positon_3p3);
gcf_t1 = tiledlayout(3,3,'TileSpacing','tight','Padding','tight');
nn = 0;
inputarea = [];
...
title(gcf_t1,'9 areas in the fourth wave','FontWeight','bold','FontSize',16)
