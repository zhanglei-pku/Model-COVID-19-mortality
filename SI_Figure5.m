...
close all;
clc;
tableSD = readtable('State-Data-wave3.csv');
...
positon_4p3 = [889,107,680,879];%4×3

gcf1 = figure('position',positon_4p3);
gcf_t1 = tiledlayout(4,3,'TileSpacing','tight','Padding','tight');
nn = 0;
inputarea = [];
...
lgd.Layout.Tile = 12;
title(gcf_t1,'11 areas in the third wave','FontWeight','bold','FontSize',16)
